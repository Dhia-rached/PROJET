...
Mat::Mat(int num_serie,int quantiter,float prix,QString nom_fournisseur,QString nom_materiel,QString type)
...
bool Mat::ajouter_materiel()
{
    ...
    QString prix_s=QString::number(prix);
          ...
          query.prepare("INSERT INTO mat (num_serie, quantiter, prix, nom_fournisseur, nom_materiel,type) "
...
QSqlQueryModel* Mat::afficher_materiel()
{
    ...
    QSqlQueryModel*  model=new QSqlQueryModel();
          ...
          model->setQuery("SELECT* FROM Mat ");
...
bool Mat::supprimer_materiel(int num_serie)
{
    ...
    QSqlQuery query;
    query.prepare("delet form Mat where num_serie=:num_serie ");
